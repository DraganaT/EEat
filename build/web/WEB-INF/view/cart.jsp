...
<div id="singleColumn">
    ...
    <c:if test="${!empty cart && cart.numberOfItems != 0}">
      ...
      <h4 id="subtotal"><fmt:message key="subtotal"/>:
          <fmt:formatNumber type="currency" currencySymbol="MKD " value="${cart.subtotal}"/>
      </h4>
      ...
      <table id="cartTable">
        ...
        <c:forEach var="cartItem" items="${cart.items}" varStatus="iter">
          ...
          <tr class="${((iter.index % 2) == 0) ? 'lightBlue' : 'white'}">
            ...
            <td>
                <fmt:formatNumber type="currency" currencySymbol="MKD " value="${cartItem.total}"/>
                <br>
                <span class="smallText">(
                    <fmt:formatNumber type="currency" currencySymbol="MKD " value="${product.price}"/>
